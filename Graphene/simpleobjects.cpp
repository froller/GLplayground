...
{
    VERTEX(-0.5, -0.5, 0.f,   0.f, 0.f, 1.f,   1.f, 0.f, 0.f);
    VERTEX(-0.5,  0.5, 0.f,   0.f, 0.f, 1.f,   1.f, 0.f, 0.f);
    VERTEX( 0.5,  0.5, 0.f,   0.f, 0.f, 1.f,   1.f, 0.f, 0.f);
    VERTEX( 0.5, -0.5, 0.f,   0.f, 0.f, 1.f,   1.f, 0.f, 0.f);
    ELEMENT(0, 2, 1);
...
{
    VERTEX( 0.f,  sqrtf(6.f) / -12.f,  1.f / sqrtf(3.f),    0.f,  sqrtf(6.f) / -12.f,  1.f / sqrtf(3.f),   0.f, 1.f, 1.f);
    VERTEX(-0.5,  sqrtf(6.f) / -12.f, -0.5 / sqrtf(3.f),   -0.5,  sqrtf(6.f) / -12.f, -0.5 / sqrtf(3.f),   0.f, 1.f, 1.f);
    VERTEX( 0.5,  sqrtf(6.f) / -12.f, -0.5 / sqrtf(3.f),    0.5,  sqrtf(6.f) / -12.f, -0.5 / sqrtf(3.f),   0.f, 1.f, 1.f);
    VERTEX( 0.f,  1.f / sqrtf(3.f),   -0.f,                 0.f,  1.f / sqrtf(3.f),   -0.f,                0.f, 1.f, 1.f);
