...
public:
    ...
    std::shared_ptr<Graphene::Material> m_Material;

public:
    Model(const fvec3 position = { 0, 0, 0 }, const fquat rotation = { 0, 0, 0, 1 }, const fvec3 scale = { 1, 1, 1 }, std::shared_ptr<Graphene::Material> material = nullptr) : Object(position, rotation, scale), m_Material(material) {};
